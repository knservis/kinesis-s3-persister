 ...
 */
public class S3EmitterWithMetadata implements IEmitter<byte[]> {
    private static final Log LOG = LogFactory.getLog(S3EmitterWithMetadata.class);
    protected final String s3Bucket;
    protected final String s3Endpoint;

    protected final AmazonS3Client s3client;

    public S3EmitterWithMetadata(KinesisConnectorConfiguration configuration) {
